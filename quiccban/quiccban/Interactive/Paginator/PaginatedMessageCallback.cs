...
namespace Discord.Addons.Interactive
{
    ...
    {
        public QuiccbanContext Context { get; }
        ...
        {
            var embed = _pager.Pages.ElementAt(page - 1).ToEmbedBuilder();
            embed.Color = null;
            embed.WithFooter(x => x.Text = string.Format(options.FooterFormat, page, pages));
